...
Model BaseModelBuilder::buildBaseModel() {
	Model temp;

	vector<vec4> tempPositions;
	vector<vec3> tempColors;
	vector<unsigned int> tempIndices;

	// Front
	tempPositions.push_back(vec4(0.5f, 0.5f, 0.5f, 1.0f));
	tempPositions.push_back(vec4(-0.5f, 0.5f, 0.5f, 1.0f));
	tempPositions.push_back(vec4(-0.5f, -0.5f, 0.5f, 1.0f));
	tempPositions.push_back(vec4(0.5f, -0.5f, 0.5f, 1.0f));
	...
	temp.mesh.positions = tempPositions;
	temp.mesh.colors = tempColors;
	temp.mesh.indices = tempIndices;
